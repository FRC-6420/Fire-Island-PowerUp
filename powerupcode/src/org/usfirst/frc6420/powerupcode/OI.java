...
public class OI {
    ...
    public OI() {
        ...
        button4 = new JoystickButton(joystick2, 4);
        button4.whileHeld(new LiftUp());
        button3 = new JoystickButton(joystick2, 3);
        button3.whileHeld(new LiftDown());
        button2 = new JoystickButton(joystick2, 2);
        button2.whileHeld(new GrabberIn());
        button1 = new JoystickButton(joystick2, 1);
