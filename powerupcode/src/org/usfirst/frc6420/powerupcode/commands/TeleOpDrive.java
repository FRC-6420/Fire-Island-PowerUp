...
public class TeleOpDrive extends Command {
    ...
    protected void execute() {
    	double xAxis = Robot.oi.getJoystick1().getX();
    	double yAxis = Robot.oi.getJoystick1().getY();
    	double leftMotorValue = 0;
    	double rightMotorValue = 0;
    	double tuningFactor = 0.6;
    	
    	leftMotorValue = tuningFactor * (yAxis - xAxis);
    	rightMotorValue = tuningFactor * (yAxis + xAxis);
